...
suite('Unit Tests', () => {
    ...
    test('#5 - Translate The parking lot was full. to British English', function(){
        assert.equal(translator.translate("The parking lot was full.", "american-to-british"),
        'The <span class="highlight">car park</span> was full.')
    });
    test('#6 - Translate Like a high tech Rube Goldberg machine. to British English', function(){
        assert.equal(translator.translate("Like a high tech Rube Goldberg machine.", "american-to-british"),
        'Like a high tech <span class="highlight">Heath Robinson device</span>.')
    });
    test('#7 - Translate To play hooky means to skip class or work. to British English', function(){
        assert.equal(translator.translate("To play hooky means to skip class or work.", "american-to-british"),
        'To <span class="highlight">bunk off</span> means to skip class or work.')
    });
    test('#8 - Translate No Mr. Bond, I expect you to die. to British English', function(){
        assert.equal(translator.translate("No Mr. Bond, I expect you to die.", "american-to-british"),
        'No <span class="highlight">Mr</span> Bond, I expect you to die.')
    });
    test('#9 - Translate Dr. Grosh will see you now. to British English', function(){
        assert.equal(translator.translate("Dr. Grosh will see you now.", "american-to-british"),
        '<span class="highlight">Dr</span> Grosh will see you now.')
    });
    test('#10 - Translate We watched the footie match for a while. to American English', function(){
        assert.equal(translator.translate("We watched the footie match for a while.", "british-to-american"),
        'We watched the <span class="highlight">soccer</span> match for a while.')
    });
    test('#11 - Translate Lunch is at 12:15 today. to British English', function(){
        assert.equal(translator.translate("Lunch is at 12:15 today.", "american-to-british"),
        'Lunch is at <span class="highlight">12.15</span> today.')
    });
    test('#12 - Translate Paracetamol takes up to an hour to work. to American English', function(){
        assert.equal(translator.translate("Paracetamol takes up to an hour to work.", "british-to-american"),
        '<span class="highlight">Tylenol</span> takes up to an hour to work.')
    });
    test('#13 - Translate First, caramelise the onions. to American English', function(){
        assert.equal(translator.translate("First, caramelise the onions.", "british-to-american"),
        'First, <span class="highlight">caramelize</span> the onions.')
    });
    test('#14 - Translate I spent the bank holiday at the funfair. to American English', function(){
        assert.equal(translator.translate("I spent the bank holiday at the funfair.", "british-to-american"),
        'I spent the <span class="highlight">public holiday</span> at the <span class="highlight">carnival</span>.')
    });
    test('#15 - Translate I had a bicky then went to the chippy. to American English', function(){
        assert.equal(translator.translate("I had a bicky then went to the chippy.", "british-to-american"),
        'I had a <span class="highlight">cookie</span> then went to the <span class="highlight">fish-and-chip shop</span>.')
    });
    test('#16 - Translate I\'ve just got bits and bobs in my bum bag. to American English', function(){
        assert.equal(translator.translate("I\'ve just got bits and bobs in my bum bag.", "british-to-american"),
        'I\'ve just got <span class="highlight">odds and ends</span> in my <span class="highlight">fanny pack</span>.')
    });
    test('#17 - Translate The car boot sale at Boxted Airfield was called off. to American English', function(){
        assert.equal(translator.translate("The car boot sale at Boxted Airfield was called off.", "british-to-american"),
        'The <span class="highlight">swap meet</span> at Boxted Airfield was called off.')
    });
    test('#18 - Translate Have you met Mrs Kalyani? to American English', function(){
        assert.equal(translator.translate("Have you met Mrs Kalyani?", "british-to-american"),
        'Have you met <span class="highlight">Mrs.</span> Kalyani?')
    });
    test('#19 - Translate Prof Joyner of King\'s College, London. to American English', function(){
        assert.equal(translator.translate("Prof Joyner of King's College, London.", "british-to-american"),
        '<span class=\"highlight\">Prof.</span> Joyner of King\'s College, London.')
    });
    test('#20 - Translate Tea time is usually around 4 or 4.30. to American English', function(){
        assert.equal(translator.translate("Tea time is usually around 4 or 4.30.", "british-to-american"),
